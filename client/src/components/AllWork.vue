<template>
  <div class="container-fluid" style="margin-top: 50px">
    <div class="row" style="padding: 20px">
      ...
      >
        <div>
          <div class="card shadow-lg" style="height: 700px ;margin-bottom:50px">
            <div class="">
              <div class="imgdiv">
                <img class="image1" :src="image" alt="event image" />
                <div class="overlay-text">{{ aboutImage[id] }}</div>
              </div>
            </div>

            <div class="card-body" style="text-align: center" >
              <h2 style='font-family: "Aladin", cursive;font-size: 48px; padding-bottom: 20px;'>{{ imagename[id] }}</h2>
            </div>
          </div>
        </div>
      </div>
      ...
      axios
        ...
        .then((resposne) => {
          ...
          for (let i = 0; i < data.length; i++) {
            ...
            for (let i = 0; i < this.artistwork.length; i++) {
