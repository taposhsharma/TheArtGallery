<template>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="https://www.fitoor.com.pk/wp-content/uploads/2020/10/IMG_20200929_003608.jpg" class="d-block w-100 image" alt="...">
  
      </div>
    <div class="carousel-item">
      <img src="https://images.unsplash.com/photo-1543857778-c4a1a3e0b2eb?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8YXJ0aXN0aWN8ZW58MHx8MHx8&w=1000&q=80" class="d-block w-100 image" alt="...">
 
        </div>
    <div class="carousel-item">
      <img src="https://images.pexels.com/photos/2983141/pexels-photo-2983141.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" class="d-block w-100 image" alt="...">
    </div>
  </div>
  ...
  <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleControls" data-bs-slide="next">
    ...
    <span class="visually-hidden">Next</span>
     ...
     <div class="card border-0">
       <div class="card-body">
         <div class="text-center"><h1 class="card-title">Login</h1></div>
         <br>
