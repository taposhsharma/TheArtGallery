          ...
          <div class="card shadow-lg">
            <div class="card-body">
              <div class="text-center">
                <h3 class="card-title" style='font-family: "Aladin", cursive;font-size: 48px;'>Update Event</h3>
              </div>
              <br />
              ...
              <form @submit.prevent="submitForm">
                ...
                <div class="mb-3">
                  ...
                  />
                  <div class="imgdiv">
                    <img class="image1" :src="imagePreview" alt="event image" />
                  </div>
                </div>
...
export default {
  ...
  created() {
    ...
    if (user === null) {
      ...
      axios
        .get("http://localhost:5000/post/updatepost/" + this.id)
        .then((response) => {
  ...
  methods: {
    ...
    submitForm() {
      ...
      axios.defaults.headers.common["Authorization"] = this.token;
      axios
        .post("http://localhost:5000/post/updatepost", formData)
        .then((response) => {
